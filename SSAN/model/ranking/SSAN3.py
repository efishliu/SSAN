...
class SSAN3(SocialRecommender,GraphRecommender):
    def __init__(self, conf, trainingSet=None, testSet=None, relation=None, fold='[1]'):
        GraphRecommender.__init__(self, conf=conf, trainingSet=trainingSet, testSet=testSet, fold=fold)
        SocialRecommender.__init__(self, conf=conf, trainingSet=trainingSet, testSet=testSet, relation=relation,fold=fold)

    def readConfiguration(self):
        super(SSAN3, self).readConfiguration()
        args = config.OptionConf(self.config['SSAN3'])
    ...
    def initModel(self):
        super(SSAN3, self).initModel()
        print("no self-supervised sign")
        print("without j channel")
        ...
        for k in range(self.n_layers):
            mixed_embedding = channel_attention(user_embeddings_c1, user_embeddings_c3)[0] + simple_user_embeddings / 2
        ...
        final_user_embeddings,self.attention_score = channel_attention(user_embeddings_c1,user_embeddings_c3)
